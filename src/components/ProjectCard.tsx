...
const ProjectCard: React.FC<{ title: string; description: string; image: string; technologies: string; onClick: () => void }> = ({ title, description, image, technologies, onClick }) => {
    return (
        <div className="relative h-100 flex flex-col bg-white rounded-3xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-500 group" onClick={onClick}>
